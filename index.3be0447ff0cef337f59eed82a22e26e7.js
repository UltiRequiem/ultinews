...
`:
  ...
  // deno:file:///home/runner/work/ultinews/ultinews/src/components/Footer.tsx
  function Footer() {
    return /* @__PURE__ */ Z("footer", {
      class: Yt`text(center gray-500) mt-10 mb-5`
  ...
  function ItemList({ items }) {
    return /* @__PURE__ */ Z("ul", {
      class: Yt`bg-indigo-400 rounded-lg p-4 m-3 min-w-[80%]`
    }, items.map((item) => /* @__PURE__ */ Z(NewItem, {
      item
    })));
  }
  ...
  function App() {
    ...
    return /* @__PURE__ */ Z("main", {
      ...
      class: Yt`md:text-7xl text-5xl m-5 underline`
    }, "UltiNews"), /* @__PURE__ */ Z("form", {
      onSubmit,
      class: Yt`flex gap-3`
    }, /* @__PURE__ */ Z("label", null, /* @__PURE__ */ Z("input", {
      class: Yt`p-2 rounded w-full`,
      type: "text",
      value: query,
      onInput: handleInput
    })), /* @__PURE__ */ Z("button", {
      class: Yt`focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800`,
      type: "submit",
